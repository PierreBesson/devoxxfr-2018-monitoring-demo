...
public class PaymentResourceIntTest {
    ...
    public void createPayment() throws Exception {
        ...
        assertThat(testPayment.getBuyerName()).isEqualTo(DEFAULT_BUYER_NAME);
    ...
    @Test
    @Transactional
    public void checkBuyerNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = paymentRepository.findAll().size();
        // set the field null
        payment.setBuyerName(null);
    ...
    public void updatePayment() throws Exception {
        ...
        assertThat(testPayment.getBuyerName()).isEqualTo(UPDATED_BUYER_NAME);
