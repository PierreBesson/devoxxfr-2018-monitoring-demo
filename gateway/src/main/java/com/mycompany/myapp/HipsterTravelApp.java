...
@EnableZuulProxy
public class HipsterTravelApp {

    private static final Logger log = LoggerFactory.getLogger(HipsterTravelApp.class);

    private final Environment env;

    public HipsterTravelApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes hipsterTravel.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HipsterTravelApp.class);
